...
public final class LoginGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.jogit.server.grpc.LoginRequest,
      com.jogit.server.grpc.LoginReply> getLoginMethod;

  public static io.grpc.MethodDescriptor<com.jogit.server.grpc.LoginRequest,
      com.jogit.server.grpc.LoginReply> getLoginMethod() {
    io.grpc.MethodDescriptor<com.jogit.server.grpc.LoginRequest, com.jogit.server.grpc.LoginReply> getLoginMethod;
    if ((getLoginMethod = LoginGrpc.getLoginMethod) == null) {
      synchronized (LoginGrpc.class) {
        if ((getLoginMethod = LoginGrpc.getLoginMethod) == null) {
          LoginGrpc.getLoginMethod = getLoginMethod = 
              io.grpc.MethodDescriptor.<com.jogit.server.grpc.LoginRequest, com.jogit.server.grpc.LoginReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "helloworld.Login", "Login"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.jogit.server.grpc.LoginRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.jogit.server.grpc.LoginReply.getDefaultInstance()))
  ...
  public static abstract class LoginImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void login(com.jogit.server.grpc.LoginRequest request,
        io.grpc.stub.StreamObserver<com.jogit.server.grpc.LoginReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.jogit.server.grpc.LoginRequest,
                com.jogit.server.grpc.LoginReply>(
                  this, METHODID_LOGIN)))
          .build();
    }
  }
  ...
  public static final class LoginBlockingStub extends io.grpc.stub.AbstractStub<LoginBlockingStub> {
    ...
    /**
     */
    public com.jogit.server.grpc.LoginReply login(com.jogit.server.grpc.LoginRequest request) {
  ...
  public static final class LoginFutureStub extends io.grpc.stub.AbstractStub<LoginFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.jogit.server.grpc.LoginReply> login(
        com.jogit.server.grpc.LoginRequest request) {
  ...
  public static abstract class LoginVertxImplBase implements io.grpc.BindableService {
     ...
     */
    public void login(com.jogit.server.grpc.LoginRequest request,
        io.vertx.core.Future<com.jogit.server.grpc.LoginReply> response) {
  ...
  public static final class LoginVertxStub extends io.grpc.stub.AbstractStub<LoginVertxStub> {
     ...
     */
    public void login(com.jogit.server.grpc.LoginRequest request,
        io.vertx.core.Handler<io.vertx.core.AsyncResult<com.jogit.server.grpc.LoginReply>> response) {
      asyncUnaryCall(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOGIN:
          serviceImpl.login((com.jogit.server.grpc.LoginRequest) request,
              (io.grpc.stub.StreamObserver<com.jogit.server.grpc.LoginReply>) responseObserver);
          break;
        default:
  ...
  private static final class VertxMethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOGIN:
          serviceImpl.login((com.jogit.server.grpc.LoginRequest) request,
              (io.vertx.core.Future<com.jogit.server.grpc.LoginReply>) io.vertx.core.Future.<com.jogit.server.grpc.LoginReply>future().setHandler(ar -> {
                if (ar.succeeded()) {
                  ((io.grpc.stub.StreamObserver<com.jogit.server.grpc.LoginReply>) responseObserver).onNext(ar.result());
  ...
  private static abstract class LoginBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.jogit.server.grpc.LoginProto.getDescriptor();
    }
