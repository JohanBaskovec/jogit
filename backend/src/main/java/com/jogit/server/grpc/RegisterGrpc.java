...
public final class RegisterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.jogit.server.grpc.RegisterRequest,
      com.jogit.server.grpc.RegisterReply> getRegisterMethod;

  public static io.grpc.MethodDescriptor<com.jogit.server.grpc.RegisterRequest,
      com.jogit.server.grpc.RegisterReply> getRegisterMethod() {
    io.grpc.MethodDescriptor<com.jogit.server.grpc.RegisterRequest, com.jogit.server.grpc.RegisterReply> getRegisterMethod;
      ...
      synchronized (RegisterGrpc.class) {
        if ((getRegisterMethod = RegisterGrpc.getRegisterMethod) == null) {
          RegisterGrpc.getRegisterMethod = getRegisterMethod = 
              io.grpc.MethodDescriptor.<com.jogit.server.grpc.RegisterRequest, com.jogit.server.grpc.RegisterReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "helloworld.Register", "Register"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.jogit.server.grpc.RegisterRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.jogit.server.grpc.RegisterReply.getDefaultInstance()))
  ...
  public static abstract class RegisterImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void register(com.jogit.server.grpc.RegisterRequest request,
        io.grpc.stub.StreamObserver<com.jogit.server.grpc.RegisterReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.jogit.server.grpc.RegisterRequest,
                com.jogit.server.grpc.RegisterReply>(
  ...
  public static final class RegisterBlockingStub extends io.grpc.stub.AbstractStub<RegisterBlockingStub> {
    ...
    /**
     */
    public com.jogit.server.grpc.RegisterReply register(com.jogit.server.grpc.RegisterRequest request) {
  ...
  public static final class RegisterFutureStub extends io.grpc.stub.AbstractStub<RegisterFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.jogit.server.grpc.RegisterReply> register(
        com.jogit.server.grpc.RegisterRequest request) {
  ...
  public static abstract class RegisterVertxImplBase implements io.grpc.BindableService {
     ...
     */
    public void register(com.jogit.server.grpc.RegisterRequest request,
        io.vertx.core.Future<com.jogit.server.grpc.RegisterReply> response) {
  ...
  public static final class RegisterVertxStub extends io.grpc.stub.AbstractStub<RegisterVertxStub> {
     ...
     */
    public void register(com.jogit.server.grpc.RegisterRequest request,
        io.vertx.core.Handler<io.vertx.core.AsyncResult<com.jogit.server.grpc.RegisterReply>> response) {
      asyncUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REGISTER:
          serviceImpl.register((com.jogit.server.grpc.RegisterRequest) request,
              (io.grpc.stub.StreamObserver<com.jogit.server.grpc.RegisterReply>) responseObserver);
          break;
        default:
  ...
  private static final class VertxMethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REGISTER:
          serviceImpl.register((com.jogit.server.grpc.RegisterRequest) request,
              (io.vertx.core.Future<com.jogit.server.grpc.RegisterReply>) io.vertx.core.Future.<com.jogit.server.grpc.RegisterReply>future().setHandler(ar -> {
                if (ar.succeeded()) {
                  ((io.grpc.stub.StreamObserver<com.jogit.server.grpc.RegisterReply>) responseObserver).onNext(ar.result());
  ...
  private static abstract class RegisterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.jogit.server.grpc.RegisterProto.getDescriptor();
    }
