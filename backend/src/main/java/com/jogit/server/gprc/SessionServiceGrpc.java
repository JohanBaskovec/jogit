...
public final class SessionServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.jogit.server.gprc.GetCurrentSessionRequest,
      com.jogit.server.gprc.GetCurrentSessionReply> getGetCurrentSessionMethod;

  public static io.grpc.MethodDescriptor<com.jogit.server.gprc.GetCurrentSessionRequest,
      com.jogit.server.gprc.GetCurrentSessionReply> getGetCurrentSessionMethod() {
    io.grpc.MethodDescriptor<com.jogit.server.gprc.GetCurrentSessionRequest, com.jogit.server.gprc.GetCurrentSessionReply> getGetCurrentSessionMethod;
      ...
      synchronized (SessionServiceGrpc.class) {
        if ((getGetCurrentSessionMethod = SessionServiceGrpc.getGetCurrentSessionMethod) == null) {
          SessionServiceGrpc.getGetCurrentSessionMethod = getGetCurrentSessionMethod =
              io.grpc.MethodDescriptor.<com.jogit.server.gprc.GetCurrentSessionRequest, com.jogit.server.gprc.GetCurrentSessionReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "helloworld.SessionService", "getCurrentSession"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.jogit.server.gprc.GetCurrentSessionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.jogit.server.gprc.GetCurrentSessionReply.getDefaultInstance()))
  ...
  public static abstract class SessionServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getCurrentSession(com.jogit.server.gprc.GetCurrentSessionRequest request,
        io.grpc.stub.StreamObserver<com.jogit.server.gprc.GetCurrentSessionReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.jogit.server.gprc.GetCurrentSessionRequest,
                com.jogit.server.gprc.GetCurrentSessionReply>(
  ...
  public static final class SessionServiceBlockingStub extends io.grpc.stub.AbstractStub<SessionServiceBlockingStub> {
    ...
    /**
     */
    public com.jogit.server.gprc.GetCurrentSessionReply getCurrentSession(com.jogit.server.gprc.GetCurrentSessionRequest request) {
  ...
  public static final class SessionServiceFutureStub extends io.grpc.stub.AbstractStub<SessionServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.jogit.server.gprc.GetCurrentSessionReply> getCurrentSession(
        com.jogit.server.gprc.GetCurrentSessionRequest request) {
  ...
  public static abstract class SessionServiceVertxImplBase implements io.grpc.BindableService {
     ...
     */
    public void getCurrentSession(com.jogit.server.gprc.GetCurrentSessionRequest request,
        io.vertx.core.Future<com.jogit.server.gprc.GetCurrentSessionReply> response) {
  ...
  public static final class SessionServiceVertxStub extends io.grpc.stub.AbstractStub<SessionServiceVertxStub> {
     ...
     */
    public void getCurrentSession(com.jogit.server.gprc.GetCurrentSessionRequest request,
        io.vertx.core.Handler<io.vertx.core.AsyncResult<com.jogit.server.gprc.GetCurrentSessionReply>> response) {
      asyncUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CURRENT_SESSION:
          serviceImpl.getCurrentSession((com.jogit.server.gprc.GetCurrentSessionRequest) request,
              (io.grpc.stub.StreamObserver<com.jogit.server.gprc.GetCurrentSessionReply>) responseObserver);
          break;
        default:
  ...
  private static final class VertxMethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CURRENT_SESSION:
          serviceImpl.getCurrentSession((com.jogit.server.gprc.GetCurrentSessionRequest) request,
              (io.vertx.core.Future<com.jogit.server.gprc.GetCurrentSessionReply>) io.vertx.core.Future.<com.jogit.server.gprc.GetCurrentSessionReply>future().setHandler(ar -> {
                if (ar.succeeded()) {
                  ((io.grpc.stub.StreamObserver<com.jogit.server.gprc.GetCurrentSessionReply>) responseObserver).onNext(ar.result());
  ...
  private static abstract class SessionServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.jogit.server.gprc.SessionProto.getDescriptor();
    }
