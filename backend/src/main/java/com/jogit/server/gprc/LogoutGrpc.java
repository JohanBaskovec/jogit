...
public final class LogoutGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.jogit.server.gprc.LogoutRequest,
      com.jogit.server.gprc.LogoutReply> getLogoutMethod;

  public static io.grpc.MethodDescriptor<com.jogit.server.gprc.LogoutRequest,
      com.jogit.server.gprc.LogoutReply> getLogoutMethod() {
    io.grpc.MethodDescriptor<com.jogit.server.gprc.LogoutRequest, com.jogit.server.gprc.LogoutReply> getLogoutMethod;
      ...
      synchronized (LogoutGrpc.class) {
        if ((getLogoutMethod = LogoutGrpc.getLogoutMethod) == null) {
          LogoutGrpc.getLogoutMethod = getLogoutMethod =
              io.grpc.MethodDescriptor.<com.jogit.server.gprc.LogoutRequest, com.jogit.server.gprc.LogoutReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "helloworld.Logout", "Logout"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.jogit.server.gprc.LogoutRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.jogit.server.gprc.LogoutReply.getDefaultInstance()))
  ...
  public static abstract class LogoutImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void logout(com.jogit.server.gprc.LogoutRequest request,
        io.grpc.stub.StreamObserver<com.jogit.server.gprc.LogoutReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.jogit.server.gprc.LogoutRequest,
                com.jogit.server.gprc.LogoutReply>(
  ...
  public static final class LogoutBlockingStub extends io.grpc.stub.AbstractStub<LogoutBlockingStub> {
    ...
    /**
     */
    public com.jogit.server.gprc.LogoutReply logout(com.jogit.server.gprc.LogoutRequest request) {
  ...
  public static final class LogoutFutureStub extends io.grpc.stub.AbstractStub<LogoutFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.jogit.server.gprc.LogoutReply> logout(
        com.jogit.server.gprc.LogoutRequest request) {
  ...
  public static abstract class LogoutVertxImplBase implements io.grpc.BindableService {
     ...
     */
    public void logout(com.jogit.server.gprc.LogoutRequest request,
        io.vertx.core.Future<com.jogit.server.gprc.LogoutReply> response) {
  ...
  public static final class LogoutVertxStub extends io.grpc.stub.AbstractStub<LogoutVertxStub> {
     ...
     */
    public void logout(com.jogit.server.gprc.LogoutRequest request,
        io.vertx.core.Handler<io.vertx.core.AsyncResult<com.jogit.server.gprc.LogoutReply>> response) {
      asyncUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOGOUT:
          serviceImpl.logout((com.jogit.server.gprc.LogoutRequest) request,
              (io.grpc.stub.StreamObserver<com.jogit.server.gprc.LogoutReply>) responseObserver);
          break;
        default:
  ...
  private static final class VertxMethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOGOUT:
          serviceImpl.logout((com.jogit.server.gprc.LogoutRequest) request,
              (io.vertx.core.Future<com.jogit.server.gprc.LogoutReply>) io.vertx.core.Future.<com.jogit.server.gprc.LogoutReply>future().setHandler(ar -> {
                if (ar.succeeded()) {
                  ((io.grpc.stub.StreamObserver<com.jogit.server.gprc.LogoutReply>) responseObserver).onNext(ar.result());
  ...
  private static abstract class LogoutBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.jogit.server.gprc.LogoutProto.getDescriptor();
    }
