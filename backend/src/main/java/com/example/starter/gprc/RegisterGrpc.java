...
public final class RegisterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.starter.gprc.RegisterRequest,
      com.example.starter.gprc.RegisterReply> getRegisterMethod;

  public static io.grpc.MethodDescriptor<com.example.starter.gprc.RegisterRequest,
      com.example.starter.gprc.RegisterReply> getRegisterMethod() {
    io.grpc.MethodDescriptor<com.example.starter.gprc.RegisterRequest, com.example.starter.gprc.RegisterReply> getRegisterMethod;
      ...
      synchronized (RegisterGrpc.class) {
        if ((getRegisterMethod = RegisterGrpc.getRegisterMethod) == null) {
          RegisterGrpc.getRegisterMethod = getRegisterMethod = 
              io.grpc.MethodDescriptor.<com.example.starter.gprc.RegisterRequest, com.example.starter.gprc.RegisterReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "helloworld.Register", "Register"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.starter.gprc.RegisterRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.starter.gprc.RegisterReply.getDefaultInstance()))
  ...
  public static abstract class RegisterImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void register(com.example.starter.gprc.RegisterRequest request,
        io.grpc.stub.StreamObserver<com.example.starter.gprc.RegisterReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.example.starter.gprc.RegisterRequest,
                com.example.starter.gprc.RegisterReply>(
  ...
  public static final class RegisterBlockingStub extends io.grpc.stub.AbstractStub<RegisterBlockingStub> {
     ...
     * </pre>
     */
    public com.example.starter.gprc.RegisterReply register(com.example.starter.gprc.RegisterRequest request) {
  ...
  public static final class RegisterFutureStub extends io.grpc.stub.AbstractStub<RegisterFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.starter.gprc.RegisterReply> register(
        com.example.starter.gprc.RegisterRequest request) {
  ...
  public static abstract class RegisterVertxImplBase implements io.grpc.BindableService {
     ...
     */
    public void register(com.example.starter.gprc.RegisterRequest request,
        io.vertx.core.Future<com.example.starter.gprc.RegisterReply> response) {
  ...
  public static final class RegisterVertxStub extends io.grpc.stub.AbstractStub<RegisterVertxStub> {
     ...
     */
    public void register(com.example.starter.gprc.RegisterRequest request,
        io.vertx.core.Handler<io.vertx.core.AsyncResult<com.example.starter.gprc.RegisterReply>> response) {
      asyncUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REGISTER:
          serviceImpl.register((com.example.starter.gprc.RegisterRequest) request,
              (io.grpc.stub.StreamObserver<com.example.starter.gprc.RegisterReply>) responseObserver);
          break;
        default:
  ...
  private static final class VertxMethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REGISTER:
          serviceImpl.register((com.example.starter.gprc.RegisterRequest) request,
              (io.vertx.core.Future<com.example.starter.gprc.RegisterReply>) io.vertx.core.Future.<com.example.starter.gprc.RegisterReply>future().setHandler(ar -> {
                if (ar.succeeded()) {
                  ((io.grpc.stub.StreamObserver<com.example.starter.gprc.RegisterReply>) responseObserver).onNext(ar.result());
  ...
  private static abstract class RegisterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.starter.gprc.RegisterProto.getDescriptor();
    }
