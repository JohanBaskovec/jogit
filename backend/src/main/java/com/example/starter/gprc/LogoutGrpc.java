...
public final class LogoutGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.starter.gprc.LogoutRequest,
      com.example.starter.gprc.LogoutReply> getLogoutMethod;

  public static io.grpc.MethodDescriptor<com.example.starter.gprc.LogoutRequest,
      com.example.starter.gprc.LogoutReply> getLogoutMethod() {
    io.grpc.MethodDescriptor<com.example.starter.gprc.LogoutRequest, com.example.starter.gprc.LogoutReply> getLogoutMethod;
      ...
      synchronized (LogoutGrpc.class) {
        if ((getLogoutMethod = LogoutGrpc.getLogoutMethod) == null) {
          LogoutGrpc.getLogoutMethod = getLogoutMethod = 
              io.grpc.MethodDescriptor.<com.example.starter.gprc.LogoutRequest, com.example.starter.gprc.LogoutReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "helloworld.Logout", "Logout"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.starter.gprc.LogoutRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.starter.gprc.LogoutReply.getDefaultInstance()))
  ...
  public static abstract class LogoutImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void logout(com.example.starter.gprc.LogoutRequest request,
        io.grpc.stub.StreamObserver<com.example.starter.gprc.LogoutReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.example.starter.gprc.LogoutRequest,
                com.example.starter.gprc.LogoutReply>(
  ...
  public static final class LogoutBlockingStub extends io.grpc.stub.AbstractStub<LogoutBlockingStub> {
    ...
    /**
     */
    public com.example.starter.gprc.LogoutReply logout(com.example.starter.gprc.LogoutRequest request) {
  ...
  public static final class LogoutFutureStub extends io.grpc.stub.AbstractStub<LogoutFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.starter.gprc.LogoutReply> logout(
        com.example.starter.gprc.LogoutRequest request) {
  ...
  public static abstract class LogoutVertxImplBase implements io.grpc.BindableService {
     ...
     */
    public void logout(com.example.starter.gprc.LogoutRequest request,
        io.vertx.core.Future<com.example.starter.gprc.LogoutReply> response) {
  ...
  public static final class LogoutVertxStub extends io.grpc.stub.AbstractStub<LogoutVertxStub> {
     ...
     */
    public void logout(com.example.starter.gprc.LogoutRequest request,
        io.vertx.core.Handler<io.vertx.core.AsyncResult<com.example.starter.gprc.LogoutReply>> response) {
      asyncUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOGOUT:
          serviceImpl.logout((com.example.starter.gprc.LogoutRequest) request,
              (io.grpc.stub.StreamObserver<com.example.starter.gprc.LogoutReply>) responseObserver);
          break;
        default:
  ...
  private static final class VertxMethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOGOUT:
          serviceImpl.logout((com.example.starter.gprc.LogoutRequest) request,
              (io.vertx.core.Future<com.example.starter.gprc.LogoutReply>) io.vertx.core.Future.<com.example.starter.gprc.LogoutReply>future().setHandler(ar -> {
                if (ar.succeeded()) {
                  ((io.grpc.stub.StreamObserver<com.example.starter.gprc.LogoutReply>) responseObserver).onNext(ar.result());
  ...
  private static abstract class LogoutBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.starter.gprc.LogoutProto.getDescriptor();
    }
